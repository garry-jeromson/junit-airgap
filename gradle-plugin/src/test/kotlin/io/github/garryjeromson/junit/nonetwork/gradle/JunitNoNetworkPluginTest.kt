 ...
 */
class JunitNoNetworkPluginTest {
    @TempDir
    ...
    fun `plugin creates junit-platform properties file`() {
        ...
        assertTrue(
            content.contains("junit.nonetwork.applyToAllTests=true"),
    ...
    fun `plugin configures test tasks with system properties`() {
        ...
        assertTrue(
            result.output.contains("junit.nonetwork.applyToAllTests = true"),
    ...
    fun `plugin supports debug mode configuration`() {
        ...
        val content = propsFile.readText()
        assertTrue(
            content.contains("junit.nonetwork.debug=true"),
